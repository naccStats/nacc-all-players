/* eslint-disable */
// Source: https://github.com/ngr900/constellation
// Vendored locally (not on npm) with ES module exports appended at bottom.
...
// ── ES module exports ──────────────────────────────────────────────────────
export { constellation, constellationFull, constellationPreset,
         constellationHue, constellationHSL, constellationRandom };

/**
 * createConstellation(elementId, presetName) → cleanup fn
 * Initializes a preset and returns a cleanup fn that removes the instance
 * from the global draw loop — safe to call on React component unmount.
 */
export function createConstellation(elementId, presetName) {
